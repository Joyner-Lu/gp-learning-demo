...
import com.joyner.gp_learning.netty_related.my_rpc_v2.rpc.protocol.PacketHeader;
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        ctx.executor().parent().next().execute(()->{
            try {
                ...
                System.out.println(packetMsg.getPacketContent());
                ...
                PacketContent requestBody = packetMsg.getPacketContent();
                ...
                PacketContent returnPacketContent = new PacketContent();
                returnPacketContent.setRes(res);
                byte[] packetBodyBytes = ObjectUtils.objToBytes(returnPacketContent);

...
public class ResponseMappingCallback {
    ...
    private static ConcurrentHashMap<Long, CompletableFuture<String>> callbackMap = new ConcurrentHashMap();
    ...
    public static void runCallBack(PacketMsg msg) {
        ...
        callbackMap.get(requestId).complete(msg.getPacketBody().getRes());

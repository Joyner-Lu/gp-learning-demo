package com.joyner.gp_learning.spring_related.springmvc_mini.core.v2.servlet;

import com.joyner.gp_learning.spring_related.springmvc_mini.core.annotation.*;
...
public class GPDispatcherServlet extends HttpServlet {
    ...
    private void doDispatch(HttpServletRequest req, HttpServletResponse resp) throws Exception {
        ...
        Object[] params = buildParams(method,parameterTypes, req, resp);
        //4.执行
        Object val = method.invoke(bean, params);
    ...
    private Object[] buildParams(Method method, Class[] parameterTypes, HttpServletRequest req, HttpServletResponse resp) {
        ...
        for (int paramIdx = 0; paramIdx < parameterAnnotations.length; paramIdx++) {
            for (int annotationIdx = 0; annotationIdx < parameterAnnotations[paramIdx].length; annotationIdx++) {
                ...
                if (annotation instanceof GPRequestParam) {
                    ...
                    Object convertVal = convertType(parameterTypes[paramIdx], val);
                    params[paramIdx] = convertVal;
